    ...
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
        <ul class="flex items-center flex-col md:flex-row">
            ...
            <li class="md:ml-16  mt-3 md:mt-0">
                <a href="{{route('movies.index')}}" class="hover:text-gray-300">Películas</a>
            </li>
        ...
        <div class="flex flex-col md:flex-row items-center">
            <livewire:search-dropdown>
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img
                            src="https://scontent-mad1-1.xx.fbcdn.net/v/t1.0-1/p160x160/43787762_10212154781200464_5234157398163193856_o.jpg?_nc_cat=109&_nc_sid=dbb9e7&_nc_ohc=UboFsUnavFAAX8iZlyl&_nc_ht=scontent-mad1-1.xx&_nc_tp=6&oh=fbabbd98ded672c02301015363ea23d9&oe=5EAE5EC2"
